...
- **Email:** [Open a private advisory](https://github.com/epicsagas/Episteme/security/advisories/new) on GitHub
- **Response time:** We aim to acknowledge within 48 hours and resolve within 14 days

## Scope

Episteme runs entirely offline as a local binary — it makes no external network calls in normal operation.
