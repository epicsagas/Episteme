...
`epis install` नॉलेज ग्राफ डेटाबेस को इनिशियलाइज़ करता है — इस चरण के बिना MCP टूल्स काम नहीं करेंगे। इसके बाद नया Claude Code सेशन शुरू करें और तैयार हैं।
...
`epis install` नॉलेज ग्राफ डेटाबेस को इनिशियलाइज़ करता है — इस चरण के बिना MCP टूल्स काम नहीं करेंगे। इसके बाद नया सेशन शुरू करें और तुरंत उपलब्ध है।
